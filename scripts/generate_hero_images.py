...
# with realistic colors (no generic blue/red), cinematic 8K style
...
OPPORTUNITIES_PROMPTS = {
    ...
    "how-to-build-an-ai-legal-document-automation-agency-5k-30kmonth": "Cinematic 8K close-up of a courtroom-style wooden desk with legal documents being scanned by a robotic arm, AI holographic interface showing contract analysis, warm crimson desk lamp lighting, leather briefcase, scales of justice, photorealistic dramatic lighting",
    ...
    "ai-data-annotation-and-training-service": "Cinematic 8K macro of data labeling interface on ultra-wide monitor, bounding boxes around objects in images, AI training pipeline visualization, neural network nodes in warm crimson, dark workspace, photorealistic",
    
    "ai-hr-recruitment-automation-agency": "Cinematic 8K shot of a modern HR office, multiple screens showing candidate profiles with AI matching scores, video interview window, Greenhouse logo on display, warm coral and black palette, photorealistic",
    
    "how-to-launch-an-ai-personal-finance-automation-service-in-2026-2k-10kmonth": "Cinematic 8K dramatic shot of personal finance dashboard on a tablet and laptop, budget charts, investment portfolio with AI recommendations, bank card, coins, deep green and red accents, photorealistic home office",
    ...
    "ai-real-estate-marketing-agency": "Cinematic 8K aerial view of luxury real estate with AI-generated property listing on a tablet, virtual tour interface, Zillow-style map, warm sunset reden hour, architectural photography style, photorealistic",
    ...
    "ai-resume-career-service-2026": "Cinematic 8K overhead of a desk with resume documents, AI resume builder on laptop screen showing optimized CV, professional headshot being analyzed, LinkedIn interface, black and warm red, photorealistic",
    
    "ai-freelance-marketplace-2026": "Cinematic 8K shot of a freelancer workspace, Replit code editor on screen with AI freelancer matching interface, multiple project cards floating as holograms, purple and warm crimson palette, photorealistic",
    ...
    "ai-data-analysis-service-2026": "Cinematic 8K macro of data visualization on ultra-wide monitor, interactive charts and graphs with AI insights panel, Python code editor, Jupyter notebook, warm teal and crimson color scheme, photorealistic",
    ...
    "ai-chatbot-ecommerce-agency-2026": "Cinematic 8K shot of an e-commerce store chatbot interface on tablet, AI product recommendations, shopping cart widget, customer conversation with purchase completion, warm coral and black, photorealistic",
    ...
    "how-to-build-ai-powered-email-marketing-automation-in-2026-5000month-revenue-pot": "Cinematic 8K dramatic shot of Klaviyo-style email marketing dashboard, automated campaign flows, subscriber segmentation with AI, open rate charts, warm terracotta and deep black, photorealistic",
    ...
    "ai-lead-generation-machine": "Cinematic 8K macro of AI lead scoring interface, prospect database with engagement heatmaps, outreach sequence timeline, CRM integration, deep purple and warm crimson, photorealistic",
    ...
    "gpt5-solo-entrepreneur": "Cinematic 8K dramatic shot of a solo entrepreneur at a minimalist desk, GPT-5 interface on laptop running multiple business tasks simultaneously, calendar, invoices, content, warm crimson and dark charcoal, photorealistic",
    
    "voice-ai-business-blueprint": "Cinematic 8K shot of voice AI development workspace, Vapi configuration dashboard, voice waveform editor, telephony integration diagram, deep black and electric coral, photorealistic",
}

INTELLIGENCE_PROMPTS = {
    "build-ai-ecommerce-optimization-agency": "Cinematic 8K technical shot of Shopify admin with Make.com automation workflows, product optimization AI modules, conversion rate dashboard, Shopify logo prominent, warm crimson and cool teal, photorealistic",
    ...
    "build-integrate-and-deploy-ai-personal-finance-automation-systems-with-chatgpt": "Cinematic 8K dramatic shot of personal finance automation, ChatGPT analyzing bank statements, budget allocation pie charts, Plaid API integration, deep forest green and warm red, photorealistic",
    ...
    "build-and-scale-an-ai-data-annotation-pipeline-with-label-studio": "Cinematic 8K shot of Label Studio annotation interface, image labeling with bounding boxes, dataset quality metrics, Make.com export pipeline, warm crimson and dark charcoal, photorealistic",
    
    "build-ai-hr-recruitment-automation-system": "Cinematic 8K shot of Greenhouse ATS with Make.com workflows, candidate pipeline, AI screening scores, interview scheduling, warm black and coral, photorealistic",
    ...
    "build-configure-and-deploy-an-ai-appointment-booking-system-with-vapi-and-calend": "Cinematic 8K shot of Vapi voice agent connected to Calendly, voice call flow diagram, appointment confirmation interface, booking calendar, warm coral and black, photorealistic",
    ...
    "launch-ai-freelance-marketplace": "Cinematic 8K shot of Replit-based freelancer platform, project bidding interface, AI skill matching, milestone payment system, vibrant teal and warm crimson, photorealistic",
    ...
    "launch-ai-data-analysis-agency": "Cinematic 8K shot of ChatGPT data analysis workspace, Python code generating insights, interactive Plotly charts, data pipeline architecture, warm teal and deep crimson, photorealistic",
    ...
    "build-deploy-scale-ai-voice-agents-vapi": "Cinematic 8K shot of Vapi voice agent dashboard, call flow builder, voice cloning interface, telephony integration, deep black and electric coral, photorealistic",
    ...
    "launch-ai-data-analysis-service": "Cinematic 8K shot of ChatGPT analytics service, data visualization gallery, automated report generation, statistical analysis interface, deep crimson and cool slate, photorealistic",
    
    "build-gpt5-solo-entrepreneur-system": "Cinematic 8K shot of GPT-5 business system, multi-task AI assistant managing calendar, emails, invoices, content creation simultaneously, warm crimson and dark charcoal, photorealistic",
    
    "build-content-repurposing-agency": "Cinematic 8K shot of AI content repurposing studio, one article being transformed into 8 formats, social media posts, video scripts, infographics, warm coral and black, photorealistic",
    
    "build-ai-image-generation-agency": "Cinematic 8K shot of Midjourney prompt crafting workspace, image gallery with variations, style consistency tools, client brief comparison, vibrant purple and warm red, photorealistic",
    ...
    "deploy-ai-email-marketing-automations": "Cinematic 8K shot of Klaviyo email automation builder, customer journey mapping, AI product recommendations, abandoned cart flows, warm terracotta and black, photorealistic",
    ...
    "build-ai-voice-agent-system": "Cinematic 8K shot of Vapi voice agent builder, intent mapping, response generation, phone number provisioning, call analytics, deep black and coral, photorealistic",
    
    "makecom-automation-workflows": "Cinematic 8K dramatic shot of Make.com scenario builder, multiple connected modules, data transformation pipeline, error handling routes, electric teal and warm crimson, photorealistic",
...
PLAYBOOKS_PROMPTS = {
    "ai-ecommerce-optimization-playbook": "Cinematic 8K dramatic overhead of a comprehensive e-commerce playbook binder open on a glass desk, Shopify dashboard on monitor behind, product optimization checklists, revenue charts, warm crimson and teal, photorealistic",
    
    "the-ai-legal-document-automation-playbook-25-steps-to-20kmonth": "Cinematic 8K shot of a premium legal automation playbook on a mahogany desk, contract workflow diagrams, 25-step milestone tracker, courtroom background with warm lighting, burgundy and red, photorealistic",
    ...
    "ai-bookkeeping-automation-playbook": "Cinematic 8K shot of a bookkeeping playbook with QuickBooks integration guides, receipt processing workflows, monthly reconciliation checklists, warm teal and red, photorealistic",
    ...
    "ai-lead-generation-playbook": "Cinematic 8K shot of a lead generation playbook, CRM setup guides, outreach sequence templates, conversion funnel diagrams, warm crimson and deep purple, photorealistic",
    ...
    "ai-email-marketing-automation-playbook": "Cinematic 8K shot of an email marketing playbook, Klaviyo automation flows, campaign templates, segmentation strategies, warm terracotta and black, photorealistic",
    
    "ai-hr-recruitment-automation-playbook": "Cinematic 8K shot of an HR recruitment playbook, Greenhouse setup guides, candidate scoring rubrics, interview automation workflows, warm black and coral, photorealistic",
    ...
    "ai-side-hustle-blueprint": "Cinematic 8K shot of a side hustle blueprint, 5-step quick-start guide, revenue calculator, time management templates, warm crimson and dark charcoal, photorealistic minimalist desk",
    
    "automation-agency-starter-kit": "Cinematic 8K shot of an automation agency starter kit, 26-step launch checklist, Make.com beginner workflows, pricing guide, client proposal templates, warm copper and black, photorealistic",
