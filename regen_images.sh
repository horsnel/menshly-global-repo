...
TSUF=', a grand golden open book floating in deep navy space with luminous pages revealing modular workflow diagrams, geometric checklists and procedure flowcharts rendered in amber and gold, floating gold-rimmed module cards arranged in a grid pattern, crystalline milestone markers with warm golden glow, strictly using deep navy blue (#0A1628) background with gold (#F0C040) accent lighting and highlights, Tesla-inspired minimalist luxury aesthetic, bold geometric shapes with luminous gold edges and warm amber glow, abstract futuristic tech aesthetic with atmospheric depth, professional magazine cover quality, ABSOLUTELY NO TEXT NO WORDS NO LETTERS NO NUMBERS NO CHARACTERS NO WRITING NO SCRIPT NO TYPOGRAPHY NO CALLIGRAPHY NO SIGNS NO LABELS NO CAPTIONS NO CHINESE NO JAPANESE NO KOREAN NO ARABIC NO HINDI NO SYMBOLS THAT RESEMBLE WRITING completely text-free image, sharp clean vector-quality edges, 8K quality'

HPRE='Cinematic wide hero banner: a grand vaulted chamber for'
HSUF=', golden light streaming from a central floating open playbook, illuminating floating holographic procedure icons and modular step markers, deep navy atmospheric walls receding into dramatic perspective, illuminated golden columns representing playbook modules, volumetric gold light rays creating atmospheric depth, strictly using deep navy blue (#0A1628) atmospheric background with brilliant gold (#F0C040) light streams and accents, epic dramatic composition with volumetric gold light rays, Tesla-inspired minimalist luxury aesthetic, premium editorial magazine quality, ABSOLUTELY NO TEXT NO WORDS NO LETTERS NO NUMBERS NO CHARACTERS NO WRITING NO SCRIPT NO TYPOGRAPHY NO CALLIGRAPHY NO SIGNS NO LABELS NO CAPTIONS NO CHINESE NO JAPANESE NO KOREAN NO ARABIC NO HINDI NO SYMBOLS THAT RESEMBLE WRITING completely text-free image, ultra-clean sharp edges, atmospheric depth with layered navy-to-black gradient, 8K quality'
